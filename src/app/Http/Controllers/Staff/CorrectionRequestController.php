...
class CorrectionRequestController extends Controller
{
    public function pendingApproval()
	{
		...
		$user = Auth::user();
		$pendingApprovals = CorrectionRequest::where('user_id', $user->id)->where('status', 1)->paginate(15);

		return view('Common.request_list', compact('page', 'pendingApprovals'));
	}
	...
	public function approval()
	{
		$page = 'approval';
		$user = Auth::user();
		$approvals = CorrectionRequest::where('user_id', $user->id)->where('status', 2)->paginate(15);

		return view('Common.request_list', compact('page', 'approvals'));
	}
	...
	public function create(WorkTime $workTime)
	{
		...
		return view('Common.request_details', compact('user', 'attendance', 'workTime', 'breakTimes', 'correctionRequest'));
	}
