...
class AttendanceRequest extends FormRequest
{
	...
	public function rules(): array
	{
		return [
			...
			'start_time.*'   => 'before_or_equal:end_time.*|after_or_equal:clock_in_time',
			'add_start_time' => 'before_or_equal:add_end_time|after_or_equal:clock_in_time|nullable',
			'end_time'       => 'required|array',
			'end_time.*'     => 'after_or_equal:clock_in_time|before_or_equal:clock_out_time',
			'add_end_time'   => 'after_or_equal:clock_in_time|before_or_equal:clock_out_time|nullable',
	...
	public function messages(): array
	{
		return [
			...
			'end_time.*.after_or_equal'      => '休憩時間が勤務時間外です',
			'end_time.*.before_or_equal'     => '休憩時間が勤務時間外です',
			'add_end_time.after_or_equal'    => '休憩時間が勤務時間外です',
